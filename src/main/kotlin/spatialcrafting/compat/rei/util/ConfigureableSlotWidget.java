...
//
//public class ConfigureableSlotWidget extends HighlightableWidget {
//
...
//    protected boolean drawBackground, showToolTips, clickToMoreRecipes, drawHighlightedBackground;
//
//    public ConfigureableSlotWidget(int x, int y, ItemStack itemStack, boolean drawBackground, boolean showToolTips) {
//        this(x, y, Collections.singletonList(itemStack), drawBackground, showToolTips);
//    }
//
//    public ConfigureableSlotWidget(int x, int y, Collection<ItemStack> itemList, boolean drawBackground, boolean showToolTips) {
//        this(x, y, itemList.stream().map(Renderable::fromItemStack).collect(Collectors.toList()), drawBackground, showToolTips);
//    }
//
//    public ConfigureableSlotWidget(int x, int y, List<Renderer> renderers, boolean drawBackground, boolean showToolTips) {
...
//    }
//
//    public ConfigureableSlotWidget(int x, int y, List<ItemStack> itemList, boolean drawBackground, boolean showToolTips, boolean clickToMoreRecipes) {
