...
public class CommandAddSRecipe extends CommandBase {
    ...
    private static void addCrTScript(String command) {
        try {
            ...
            File scriptsDir = new File(System.getProperty("user.dir") + "\\scripts");
            if (scriptsDir.isDirectory()) {
                // Go to the spatialcrafting folder(if it doesn't exist create a new one)
                File scDir = new File(System.getProperty("user.dir") + "\\scripts" + "\\spatialcrafting");
                if (!scDir.isDirectory()) {
                    scDir.mkdir();
                }

                // If the file doesn't exist, create a new one.
                Path path = Paths.get(System.getProperty("user.dir") + "\\scripts" + "\\spatialcrafting" + "\\___generated_spatial_recipes___.zs");
                ...
                try {
                    ...
                    SpatialCrafting.LOGGER.error(
                            "Unexpected error trying to add text to a zenscript script for a spatialcrafting recipe via acommand!",
                            e);
                }
        ...
        try {
            ...
            if (crafter != null) {
                ...
                if (isValidRecipe(input, output, player)) {
                    ...
                    String command = "mods.spatialcrafting.addRecipe(" + recipe.toFormattedString() + ",\t" + CraftTweakerIntegration.itemStackToCTString(output) + ");\n\n";
