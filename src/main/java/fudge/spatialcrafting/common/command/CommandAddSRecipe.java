...
public class CommandAddSRecipe extends CommandBase {
    ...
    private static void addCrTScript(String command) {
        try {
            final String SCRIPTS_DIR_NAME = "assets/spatialcrafting/scripts";
            ...
            File scriptsDir = new File(System.getProperty("user.dir") + "/" + SCRIPTS_DIR_NAME);
            if (scriptsDir.isDirectory()) {
                // Go to the spatialcrafting folder(if it doesn't exist create a new one)
                File scDir = new File(System.getProperty("user.dir") + "/" + SCRIPTS_DIR_NAME + "/" + SC_DIR_NAME);
                if (!scDir.isDirectory()) {
                    scDir.mkdir();
                }

                // If the file doesn't exist, create a new one.
                Path path = Paths.get(System.getProperty("user.dir") + "/" + SCRIPTS_DIR_NAME + "/" + SC_DIR_NAME + "/" + RECIPES_FILE_NAME);
